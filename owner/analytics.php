...
<div class="portal-card mb-3">
    ...
    <p class="display-6 mb-0"><?php echo e((string) $totalVisits); ?> <small class="text-secondary fs-6">візитів у системі</small></p>
</div>
...
<div class="row g-3">
        ...
        <div class="portal-card h-100">
            ...
            <ul class="mb-0">
                <?php foreach ($popularPages as $row): ?>
                    <li><?php echo e($row['route']); ?> — <?php echo e((string) $row['views']); ?> переглядів</li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
        ...
        <div class="portal-card h-100">
            ...
            <ul class="mb-0">
                <?php foreach ($topCountries as $row): ?>
                    <li><?php echo e($row['country_code']); ?> — <?php echo e((string) $row['visits']); ?> візитів</li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="portal-card h-100">
            <h3>Тренд за 14 днів</h3>
            <ul class="mb-0">
                <?php foreach ($trend as $row): ?>
                    <li><?php echo e($row['day']); ?> — <?php echo e((string) $row['visits']); ?> візитів</li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="portal-card h-100">
            ...
            <ul class="mb-0">
                <?php foreach ($topEntries as $row): ?>
                    <li><?php echo e($row['route']); ?> — <?php echo e((string) $row['entries']); ?> входів</li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
