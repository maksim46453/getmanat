...
function track_visit(string $route): void
{
    ...
    try {
        ...
        $db->query(
            'INSERT INTO website_visits (route, country_code, ip_hash, user_agent) VALUES (:route, :country, :ip_hash, :user_agent)',
            [
        ...
        // Silently ignore analytics errors to avoid impacting user experience.
    }
}
